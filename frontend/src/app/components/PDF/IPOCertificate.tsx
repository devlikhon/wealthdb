        ...
        <View>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.certificateTitle}>
              Digital Stock Ownership Certificate
            </Text>

            <Text style={styles.certificateSubTitle}>
              This certificate confirms ownership of the Stock listed below. It
              serves as proof of investment and is issued electronically by the
              company.
            </Text>
          </View>
          ...
          <View style={styles.customerSection}>
            ...
            <View style={styles.customerTextGroup}>
              ...
              <View style={styles.customerText}>
                <Text style={styles.customerTextLabel}>Stock Ticker:</Text>
                <Text>{ipo.stockTicker}</Text>
              </View>
            </View>
          </View>

          <View>
            <Text style={styles.certificateHeader}>
          ...
          <View style={styles.certificateBox}>
            <View style={styles.tableRow}>
              <Text style={styles.tableCellTitle}>Stock Ticker</Text>
              <Text style={styles.tableCellValue}>{ipo.stockTicker}</Text>
            </View>

            <View style={styles.tableRow}>
              <Text style={styles.tableCellTitle}>Stock Name</Text>
              <Text style={styles.tableCellValue}>{ipo.stockName}</Text>
            </View>

            <View style={styles.tableRow}>
              <Text style={styles.tableCellTitle}>Start Date</Text>
              <Text style={styles.tableCellValue}>
                {dayjs(ipo.startDate).format("DD MMM YYYY")}
              </Text>
            </View>
            ...
            <View style={styles.tableRow}>
              ...
              <Text style={styles.tableCellValue}>
                {dayjs(ipo.maturityDate).format("DD MMM YYYY")}
              </Text>
            </View>

            <View style={styles.tableRow}>
              <Text style={styles.tableCellTitle}>Shares Issued</Text>
              <Text style={styles.tableCellValue}>
                {Number(ipo.sharesIssued).toLocaleString()}
              </Text>
            </View>

            <View style={styles.tableRow}>
              <Text style={styles.tableCellTitle}>Shares Price</Text>
              <Text style={styles.tableCellValue}>
                £{Number(ipo.sharesPrice).toLocaleString()}
              </Text>
            </View>

            <View style={styles.tableRow}>
              <Text style={styles.tableCellTitle}>Shares Type</Text>
              <Text style={styles.tableCellValue}>{ipo.sharesType}</Text>
            </View>

            <View style={styles.tableRow}>
              <Text style={styles.tableCellTitle}>Market Listed</Text>
              <Text style={styles.tableCellValue}>{ipo.marketListed}</Text>
            </View>
          </View>
          ...
          <View style={styles.amountSection}>
            ...
            <Text style={styles.amountValue}>
              £{Number(ipo.availableForWithdraw).toLocaleString()}
            </Text>
          </View>
