...
const CompletedFunding = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      //   // if (record.status !== "Fund Active - waiting for payment")
      //   //   return null;
      //   return (
      //     <Tooltip
    ...
    },
    {
      ...
      render: (_state: any, record: any) => {
        ...
        if (record?.status?.startsWith("Payment Overdue")) {
          return (
            <Tooltip title="Open">
              <FontAwesomeIcon
        ...
        if (record.status === "Payment Confirmed") {
          return (
    ...
    },
    {
      ...
      render: (_url: any, record: any) => {
        const firstColumnVisible =
          record.status === "Fund Active - waiting for payment";
    ...
    <>
      ...
      >
        ...
        <DataTable
          ...
          data={filteredData}
          pageSize={pageSize}
          emptyText="No completed fundings to display."
        />
      </Card>
    </>
  );
