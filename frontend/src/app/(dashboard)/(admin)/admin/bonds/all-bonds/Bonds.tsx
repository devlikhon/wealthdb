...
const Bonds = () => {
  ...
  const { loading, deleteTicket, applicants } = useGlobal();

  //   const allBonds = applicants.flatMap(
  //     (applicant) => applicant.investmentDetails || [],
  //   );

  const allBonds = applicants.flatMap((app) =>
